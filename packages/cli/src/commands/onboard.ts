...
function printNextSteps(pairingUrl: string | null, paseoHome: string, richUi: boolean): void {
  ...
  const nextStepsLines = [
    ...
    "2. App: https://github.com/PCVS06/optimize-app/releases",
    "3. Desktop app: https://github.com/PCVS06/optimize-app/releases/latest",
    "4. Docs: https://github.com/PCVS06/optimize-app/blob/optimize/initial-build/branding/HELP.md",
...
export function onboardCommand(): Command {
  return new Command("onboard")
    ...
    .option("--port <port>", "Port to listen on (default: 6771)")
    .option("--home <path>", "Paseo home directory (default: ~/.optimize)")
