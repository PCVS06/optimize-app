...
const RELEASE_DOWNLOAD_BASE_URL = "https://github.com/PCVS06/optimize-app/releases/download";
...
export function buildMacAppleSiliconDownloadUrl(version: string | null | undefined): string | null {
  ...
  return `${RELEASE_DOWNLOAD_BASE_URL}/v${normalizedVersion}/Optimize-${normalizedVersion}-arm64.dmg`;
}
