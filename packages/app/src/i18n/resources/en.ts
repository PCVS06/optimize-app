export const en = {
    ...
    git: {
      actions: {
        ...
        unavailable: {
          ...
          archiveNotWorktree:
            "Archive isn't available here because this workspace was not created as a Optimize worktree",
          mergePrNoForge:
  ...
  desktop: {
    ...
    daemon: {
      ...
      management: {
        ...
        hint: "Let Optimize start and stop the built-in daemon",
        ...
        pausedStopFailed:
          "Built-in daemon management was paused, but Optimize could not stop the daemon.",
        updateFailed: "Unable to update built-in daemon management.",
      },
      keepRunning: {
        title: "Keep daemon running after quit",
        hint: "Daemon keeps running when you quit Optimize",
      },
      logs: {
        title: "Log file",
    ...
    rosetta: {
      ...
      runningIntel: "You're running the Intel build of Optimize under Rosetta on Apple Silicon.",
    ...
    permissions: {
      ...
      testNotification: {
        title: "Optimize notification test",
    ...
    integrations: {
      cli: {
        ...
        installFailed: "Unable to install the Optimize CLI.",
      },
    },
  },
  rootError: {
    title: "Optimize ran into a problem.",
  ...
  pairing: {
    ...
    direct: {
      title: "Direct connection",
      helper: "Enter the address of a Optimize server.",
      fields: {
        host: "Host",
        port: "Port",
        password: "Password",
    ...
    remoteSsh: {
      title: "Remote SSH",
      helper: "Connect to a Optimize daemon running on the remote host.",
      fields: {
        target: "SSH host",
      },
      actions: {
    ...
    device: {
      ...
      relayDocsAccessibility: "Read how Optimize relay works",
      ...
      updateRequired: "Update the host to enable relay from Optimize Desktop.",
      unavailable: "Pairing offer unavailable.",
      hint: "Scan this QR code with Optimize on your phone, or copy the link below.",
      securityWarning:
  ...
  toolCallGroup: {
    ...
    paseoCalls: {
      one: "called Optimize {{count}} time",
      other: "called Optimize {{count}} times",
    },
    and: "and",
  },
  renameModal: {
  ...
  settings: {
    ...
    notifications: {
      ...
      sentDescription: "Optimize handed the notification to the operating system.",
    ...
    metadataGeneration: {
      ...
      description:
        "Choose the model Optimize uses for workspace titles, branch names, commit messages, and pull request drafts",
      selection: "Model selection",
      automatic: "Automatic",
      preferred: "Manual",
      automaticHint: "Optimize picks a fast available model",
      preferredHint: "Choose the model Optimize uses",
      model: "Model",
      fallbackHint: "If it is unavailable, Optimize falls back to another available model",
      docs: "Docs",
    ...
    general: {
      ...
      browserData: {
        ...
        description: "Browser tabs share sign-ins and site data across Optimize.",
    ...
    about: {
      ...
      updates: {
        ...
        installMessage: "This updates Optimize on this computer",
    ...
    host: {
      ...
      skills: {
        ...
        updateTitle: "Update Optimize skills?",
        updateFallback: "Sync bundled skills to this host.",
        uninstallTitle: "Uninstall Optimize skills?",
        uninstallMessage:
          "Removes all Optimize orchestration skills from ~/.agents, ~/.claude, ~/.codex on this host.",
      ...
      orchestration: {
        ...
        enableTools: {
          title: "Enable Optimize tools",
          hint: "Agents will be able to manage worktrees, agents and schedules",
          accessibilityLabel: "Inject Optimize tools",
        },
        systemPrompt: {
          title: "System prompt",
      ...
      agentProfiles: {
        ...
        unavailable: "Connect to Optimize to manage assistants",
        unsupported: "Update Optimize to configure assistants",
        emptyState:
          "Create an assistant with its own instructions for support, product knowledge, or another team workflow.",
        addProfileTitle: "Create assistant",
        newProfile: "Create assistant",
        editProfile: "Edit assistant",
        editProfileTitle: "Edit assistant",
        nameLabel: "Name",
        ...
        notesPlaceholder: "Use for customer questions, product care, and returns.",
        notesHint:
          "Describes when this assistant should be used. Its behavior is defined in the system prompt.",
        save: "Save",
        saving: "Saving...",
        remove: "Remove",
        removeConfirmTitle: "Remove assistant?",
        removeConfirmMessage: 'Remove "{{name}}"?',
        moveUp: "Move up",
        moveDown: "Move down",
      },
      daemon: {
        ...
        restart: {
          ...
          offlineMessage:
            "This host is offline. Optimize reconnects automatically-wait until it's back online before restarting.",
          requestFailedTitle: "Error",
          requestFailedMessage:
            "Failed to send the restart request. Optimize reconnects automatically-try again once the host shows as online.",
          dialogFailedMessage: "Unable to open the restart confirmation dialog.",
        },
        update: {
          desktopManagedHint:
            "This daemon is managed by Optimize Desktop. Update Optimize Desktop on the host.",
          title: "Update daemon",
    ...
    project: {
      ...
      scripts: {
        ...
        serviceHint: "Optimize supervises the process and assigns a port via $PASEO_PORT",
        actions: {
          add: "Add script",
          edit: "Edit",
          remove: "Remove",
      ...
      metadata: {
        title: "Metadata generation",
        info: "Project-specific instructions injected into the AI prompts Optimize uses to generate metadata - use them to enforce your team's conventions like branch naming, commit style, or PR format",
